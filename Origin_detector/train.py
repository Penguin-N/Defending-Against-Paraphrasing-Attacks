    ...
    def run_training(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            if val_accuracy > best_accuracy:
                ...
                torch.save(self.model.state_dict(), "best_model_three.pt")
        ...
        self.model.load_state_dict(torch.load("best_model_three.pt"))
...
if __name__ == "__main__":
    trainer = ModelTrainer(
        "../dataset_three/HC3/train.json", "../dataset_three/HC3/val.json", "../dataset_three/HC3/test.json"
    )
