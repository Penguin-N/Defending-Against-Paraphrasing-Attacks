...
def main():
    ...
    interdata_file = "../dataset_three/ChatGPT_inter_data"
    merged_file = "../dataset_three/HC3-ChatGPT/merged.jsonl"
    train_file = "../dataset_three/HC3-ChatGPT/train.json"
    val_file = "../dataset_three/HC3-ChatGPT/val.json"
    test_file = "../dataset_three/HC3-ChatGPT/test.json"
    
    # Used for evaluation
    test_files = ["0.json","5.json","10.json","15.json","20.json","25.json"]
    test_origin_file = "../dataset_three/HC3-ChatGPT/test_origin.json"
    test_para_file = "../dataset_three/HC3-ChatGPT/test_para.json"
