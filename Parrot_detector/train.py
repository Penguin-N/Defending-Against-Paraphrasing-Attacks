...
if __name__ == "__main__":
    trainer = ModelTrainer(
        best_model_path="training_details/best_model_three.pt", train_file="../dataset_three/HC3-Parrot/train.json", 
        val_file="../dataset_three/HC3-Parrot/val.json", test_file="../dataset_three/HC3-Parrot/test.json"
    )
