...
if __name__ == "__main__":
    trainer = ModelTrainer(
        best_model_path="training_details/best_model_three.pt", train_file="../dataset_three/HC3-PEGASUS/train.json", 
        val_file="../dataset_three/HC3-PEGASUS/val.json", test_file="../dataset_three/HC3-PEGASUS/test.json"
    )
