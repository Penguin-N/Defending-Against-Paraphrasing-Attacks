...
def merge_data(input_file, interdata_files, output_file, test_files, test_origin_file, test_para_file):
    # Load data from input file
    with open(input_file, "r", encoding="utf-8") as f:
        data = [json.loads(line) for line in f]
    ...
    for interdata_file in interdata_files:
        for file in os.listdir(interdata_file):
            ...
            with open(file_path,"r",encoding="utf-8") as f:
                ...
                for i in range(len(data)):
                    d = data[i] 
                    if interdata_file == "../dataset_three/PEGASUS_inter_data":
                        d["type"] = 1
                    samples.append(d)
...
def main():
    ...
    interdata_files = ["../dataset_three/Parrot_inter_data","../dataset_three/PEGASUS_inter_data","../dataset_three/ChatGPT_inter_data"]
    merged_file = "../dataset_three/HC3-Large-new/merged.jsonl"
    train_file = "../dataset_three/HC3-Large-new/train.json"
    val_file = "../dataset_three/HC3-Large-new/val.json"
    test_file = "../dataset_three/HC3-Large-new/test.json"
    
    # Used for evaluation
    test_files = ["0.json","5.json","10.json","15.json","20.json","25.json"]
    test_origin_file = "../dataset_three/HC3-Large-new/test_origin.json"
    test_para_file = "../dataset_three/HC3-Large-new/test_para.json"
    
    # Merge data from input file and save to output file
    merge_data(input_file, interdata_files, merged_file, test_files, test_origin_file, test_para_file)
