...
if __name__ == "__main__":
    ...
    test_files  = ["../dataset_three/HC3/other.json","../dataset_three/HC3-Parrot/test_para.json","../dataset_three/HC3-PEGASUS/test_origin.json","../dataset_three/HC3-ChatGPT/test_para.json"]
    
    tester = ModelTester(
        best_model_path="training_details/best_model_four.pt", test_files=test_files
    )
    tester.test_all()
