...
class ModelTrainer:
    def __init__(
        ...
        # Record the path to the best model
...
if __name__ == "__main__":
    trainer = ModelTrainer(
        best_model_path="training_details/best_model_four.pt", train_file="../dataset_three/HC3-Large-new/train.json", 
        val_file="../dataset_three/HC3-Large-new/val.json", test_file="../dataset_three/HC3-Large-new/test.json"
    )
